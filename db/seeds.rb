...
pet9 = Pet.find_or_create_by({name: "Suco", breed:"nil", age: "2", status: "ready for adoption", color: "gray", size:"nil", fee: "50", bio: "Lorem ipsum dolor sit amet.", gender: "male", species: "n. hollandicus"})


pet_owner1 = PetOwner.find_or_create_by({pet: pet1, owner: owner1, current?: true})
pet_owner2 = PetOwner.find_or_create_by({pet: pet2, owner: owner3, current?: true})
pet_owner3 = PetOwner.find_or_create_by({pet: pet3, owner: owner3, current?: true})
pet_owner4 = PetOwner.find_or_create_by({pet: pet4, owner: owner3, current?: true})
pet_owner5 = PetOwner.find_or_create_by({pet: pet5, owner: owner2, current?: true})
